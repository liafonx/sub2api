...
const apiKeyAuthSnapshotVersion = 6 // v6: added Email, Username, BalanceNotify* fields and TotalRecharged (upstream v0.1.113)
...
func (s *APIKeyService) snapshotFromAPIKey(apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	if apiKey.Group != nil {
		snapshot.Group = &APIKeyAuthGroupSnapshot{
			...
			UserAccountAffinityEnabled:      apiKey.Group.UserAccountAffinityEnabled,
		}
	}
	return snapshot
}
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	if snapshot.Group != nil {
		apiKey.Group = &Group{
			...
			UserAccountAffinityEnabled:      snapshot.Group.UserAccountAffinityEnabled,
		}
	}
