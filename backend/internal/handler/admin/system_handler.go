...
func NewSystemHandler(updateSvc *service.UpdateService, lockSvc *service.SystemOperationLockService, ccProbeSvc *service.CCProbeService, settingSvc *service.SettingService) *SystemHandler {
