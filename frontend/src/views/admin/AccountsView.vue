<template>
  <AppLayout>
    ...
    <ChangeAccountModal :show="showChangeAccount" :account="changeAccountAcc" @close="closeChangeAccountModal" @changed="handleAccountUpdated" />
    <AccountTestModal :show="showTest" :account="testingAcc" @close="closeTestModal" />
    <AccountStatsModal :show="showStats" :account="statsAcc" @close="closeStatsModal" />
    <ScheduledTestsPanel :show="showSchedulePanel" :account-id="scheduleAcc?.id ?? null" :model-options="scheduleModelOptions" @close="closeSchedulePanel" />
    <AccountActionMenu :show="menu.show" :account="menu.acc" :position="menu.pos" @close="menu.show = false" @test="handleTest" @stats="handleViewStats" @schedule="handleSchedule" @reauth="handleReAuth" @change-account="handleChangeAccount" @refresh-token="handleRefresh" @recover-state="handleRecoverState" @reset-quota="handleResetQuota" @set-privacy="handleSetPrivacy" />
...
import ChangeAccountModal from '@/components/admin/account/ChangeAccountModal.vue'
...
const changeAccountAcc = ref<Account | null>(null)
...
const syncAccountRefs = (nextAccount: Account) => {
  ...
  if (changeAccountAcc.value?.id === nextAccount.id) changeAccountAcc.value = nextAccount
...
const closeChangeAccountModal = () => { showChangeAccount.value = false; changeAccountAcc.value = null }
...
const handleChangeAccount = (a: Account) => { changeAccountAcc.value = a; showChangeAccount.value = true }
