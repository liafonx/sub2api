export default {
  ...
  admin: {
    ...
    groups: {
      ...
      scheduledRate: {
        title: '定时费率倍数',
        hint: '根据时间段、星期或日期范围覆盖默认费率倍数。匹配第一条规则后停止。',
        timezoneWarning: '时间规则按服务器时区评估：{timezone}',
        firstMatchHint: '规则从上到下依次评估，第一条匹配即生效。',
        noRules: '暂无规则，请添加。',
        ...
        timeEnd: '结束时间（HH:MM）',
        timeModeInclude: '匹配时间窗口内',
        timeModeExclude: '匹配时间窗口外',
        dateRange: '日期范围',
        dateStart: '开始日期（含）',
        dateEnd: '结束日期（含）',
        addRule: '+ 添加规则',
        maxRulesReached: '已达规则上限（10 条）',
        daySun: '日',
        dayMon: '一',
        dayTue: '二',
        dayWed: '三',
