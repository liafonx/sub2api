export default {
  ...
  admin: {
    ...
    groups: {
      ...
      soraPricing: {
        ...
        storageQuota: "存储配额",
        storageQuotaHint:
          "单位 GB，设置该分组用户的 Sora 存储配额上限，0 表示使用系统默认",
      },
      claudeCode: {
    ...
    accounts: {
      ...
      openai: {
        ...
        enableSoraHint:
          "Sora 使用相同的 OpenAI 账号，开启后将同时创建 Sora 平台账号",
      },
      anthropic: {
      ...
      oauth: {
        ...
        openai: {
          ...
          sessionTokenDesc:
            "输入您已有的 Sora Session Token，支持批量输入（每行一个），系统将自动验证并创建账号。",
          sessionTokenPlaceholder:
            "粘贴您的 Sora Session Token...\n支持多个，每行一个",
    ...
    settings: {
      ...
      ccProbe: {
        title: "CC Probe",
        description:
          "通过 mitmproxy 从本地安装的 Claude Code 捕获版本专属请求头",
        statusVersion: "探测版本",
        statusCapturedAt: "最近捕获时间",
        statusNoData: "暂无探测数据",
        statusLoading: "正在加载探测状态...",
        configTitle: "配置",
        configNote: "以下参数在 config.yaml 中设置，修改后需重启服务生效。",
        enabled: "已启用",
        disabled: "已禁用",
        binaryPath: "二进制路径",
        autoUpdate: "自动更新",
  ...
  sora: {
    ...
    noStorageWarningDesc:
      "生成的内容仅通过上游临时链接提供，约 15 分钟后过期。建议管理员配置 S3 存储。",
    mediaTypeVideo: "视频",
    mediaTypeImage: "图片",
