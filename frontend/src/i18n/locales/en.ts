export default {
  ...
  usage: {
    ...
    estimatedLimitTooltip:
      "Estimated account limit derived from sub2api cost / utilization",
  ...
  admin: {
    ...
    groups: {
      ...
      userAccountAffinity: {
        title: "User-Account Daily Affinity",
        tooltip:
          "When enabled, the same user will be routed to the same account for the entire day (resets at the configured UTC hour). The account is only switched when it enters the Red cost zone.",
        enabled: "Affinity Enabled",
        disabled: "Affinity Disabled",
      },
      openaiMessages: {
    ...
    accounts: {
      ...
      quotaControl: {
        ...
        dynamicCost: {
          ...
          fallbackNote:
            "5h limit above is used as fallback while utilization < 5%",
