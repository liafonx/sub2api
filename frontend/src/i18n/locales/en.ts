export default {
  ...
  admin: {
    ...
    users: {
      ...
      rpmLimitMin: "RPM limit must be at least 0 (0 = unlimited)",
    ...
    accounts: {
      ...
      capacity: {
        ...
        userQuota: {
          active: "{count} active users, per-user limit: {limit}",
          inactive: "Per-user quota inactive",
        },
      },
      tempUnschedulable: {
      ...
      quotaControl: {
        ...
        dynamicCost: {
          ...
          hint: "Use real-time Anthropic billing data instead of local token estimates",
          fallbackNote:
            "Falls back to local token estimation when billing data is unavailable.",
          limit7d: "7-Day Spend Limit",
          limit7dPlaceholder: "100",
          limit7dHint:
            "Account pauses scheduling when 7-day spend reaches this limit (USD)",
          reserve7d: "7-Day Sticky Reserve",
          reserve7dPlaceholder: "20",
          reserve7dHint:
            "Extra budget reserved for sticky sessions above the 7-day limit (USD)",
        },
        userQuota: {
          label: "Per-User Quota",
          hint: "Split the window budget equally among active users to prevent one user from exhausting the account",
          requiresWindowCost: "Requires Window Cost Limit to be enabled",
          idleTimeout: "User Idle Timeout (seconds)",
          idleTimeoutPlaceholder: "60",
          idleTimeoutHint:
            "Users are removed from the active set after this idle period",
        },
        userRPM: {
          label: "Per-User RPM",
          hint: "Split account base_rpm equally among active users",
          requiresRPM: "Requires base RPM to be set",
        },
      },
    ...
    settings: {
      ...
      defaults: {
        ...
        defaultRPMLimitHint: "Maximum requests per minute for new users (0 = unlimited)",
