export default {
  ...
  redeem: {
    title: "Redeem Code",
    description:
      "Enter your redeem code to add balance or increase concurrency",
  ...
  admin: {
    ...
    accounts: {
      ...
      openai: {
        ...
        enableSoraHint:
          "Sora uses the same OpenAI account. Enable to create Sora account simultaneously.",
      },
      anthropic: {
      ...
      soraModelsLoadFailed:
        "Failed to load Sora models, fallback to default list",
      ...
      quotaControl: {
        ...
        userQuota: {
          ...
          idleTimeoutHint:
            "User slots are released after this many seconds of inactivity",
        ...
        tlsFingerprint: {
          ...
          profileHint:
            "Choose a specific TLS fingerprint profile or use auto-selection",
      ...
      soraAccountFailed:
        "Failed to create Sora account, please add manually later",
      ...
      oauth: {
        ...
        openai: {
          ...
          sessionTokenDesc:
            "Enter your existing Sora Session Token(s). Supports batch input (one per line). The system will automatically validate and create accounts.",
          sessionTokenPlaceholder:
            "Paste your Sora Session Token...\nSupports multiple, one per line",
    ...
    settings: {
      ...
      ccProbe: {
        title: "CC Probe",
        description:
          "Captures version-specific request headers from locally installed Claude Code via mitmproxy",
        statusVersion: "Probed Version",
        statusCapturedAt: "Last Captured",
        statusNoData: "No probe data available",
        statusLoading: "Loading probe status...",
        configTitle: "Configuration",
        configNote:
          "These values are set in config.yaml and require a restart to change.",
        enabled: "Enabled",
        disabled: "Disabled",
        ...
        triggerFailed: "Probe failed",
        notConfigured: "CC Probe service is not configured",
      },
      claudeCode: {
  ...
  sora: {
    ...
    notEnabledDesc:
      "The Sora Studio feature has not been enabled by the administrator. Please contact your admin.",
    ...
    noStorageWarningDesc:
      "Generated content is only available via temporary upstream links that expire in ~15 minutes. Consider configuring S3 storage.",
    ...
    closePreview: "Close",
    beforeUnloadWarning:
      "You have unsaved generated content. Are you sure you want to leave?",
    downloadTitle: "Download Generated Content",
    downloadExpirationWarning:
      "This link expires in approximately 15 minutes. Please download and save promptly.",
    ...
    welcomeSubtitle:
      "Enter a description and Sora will create realistic videos or images for you. Try the examples below to get started.",
    queueTasks: "tasks",
    queueWaiting: "Queued",
    waiting: "Waiting",
    waited: "Waited",
    ...
    subscription: "Subscription",
    noCredentialHint:
      "Please create an API Key or contact admin for subscription",
    uploadReference: "Upload reference image",
    generatingCount: "Generating {current}/{max}",
    noStorageToastMessage:
      'Cloud storage is not configured. Please use "Download" to save files after generation, otherwise they will be lost.',
    galleryCount: "{count} works",
    galleryEmptyTitle: "No works yet",
    galleryEmptyDesc:
      "Your creations will be displayed here. Go to the generate page to start your first creation.",
    ...
    square: "Square",
    examplePrompt1:
      "A golden Shiba Inu walking through the streets of Shibuya, Tokyo, camera following, cinematic shot, 4K",
    examplePrompt2:
      "Drone aerial view, green aurora reflecting on a glacial lake in Iceland, slow push-in",
    examplePrompt3:
      "Cyberpunk futuristic city, neon lights reflected in rain puddles, nightscape, cinematic colors",
    examplePrompt4:
