export default {
  ...
  admin: {
    ...
    groups: {
      ...
      scheduledRate: {
        title: 'Scheduled Rate Multiplier',
        hint: 'Override the default rate multiplier based on time of day, day of week, or date range. First matching rule wins.',
        timezoneWarning: 'Time rules are evaluated in server timezone: {timezone}',
        firstMatchHint: 'Rules are evaluated top-to-bottom; first match wins.',
        ...
        timeModeInclude: 'Match within window',
        timeModeExclude: 'Match outside window',
        dateRange: 'Date Range',
        dateStart: 'Start Date (inclusive)',
        dateEnd: 'End Date (inclusive)',
        addRule: '+ Add Rule',
        maxRulesReached: 'Maximum rules reached (10)',
        daySun: 'Sun',
        dayMon: 'Mon',
        dayTue: 'Tue',
        dayWed: 'Wed',
    ...
    accounts: {
      ...
      quotaControl: {
        ...
        tlsFingerprint: {
          ...
          profile: 'Profile',
          profileAuto: 'Auto (Built-in Default)',
          profileHint: 'Select a TLS fingerprint profile. Auto uses the built-in default.'
        },
        sessionIdMasking: {
